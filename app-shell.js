(function(){
  if(!document.querySelector('.global-rail')){
    ...
    rail.innerHTML=`
      ...
      <div class="rail-main">
        <a class="rail-item active" href="index.html" aria-label="Home" title="Home"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m4 11 8-7 8 7v8a1 1 0 0 1-1 1h-5v-6h-4v6H5a1 1 0 0 1-1-1v-8Z"/></svg><span class="rail-label">Home</span></a>
        <a class="rail-item" href="study-guide.html" aria-label="Study" title="Study"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 4h11a3 3 0 0 1 3 3v13H8a3 3 0 0 1-3-3V4Z"/><path d="M8 8h7M8 12h7M8 16h4"/></svg><span class="rail-label">Study</span></a>
        <a class="rail-item" href="architecture-practice.html" aria-label="Practice" title="Practice"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 4h8a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M9 9h6M9 13h4M9 17h2"/></svg><span class="rail-label">Practice</span></a>
        <a class="rail-item" href="mock-exams.html" aria-label="Exams" title="Exams"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg><span class="rail-label">Exams</span></a>
