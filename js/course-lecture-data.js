(function(){
  ...
  const awsDoc=(title,url)=>({title,url});
  const sectionAwsDocs=[
    [awsDoc('AWS overview','https://docs.aws.amazon.com/whitepapers/latest/aws-overview/introduction.html'),awsDoc('SAA-C03 exam guide','https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03.html')],
    [awsDoc('AWS documentation','https://docs.aws.amazon.com/'),awsDoc('SAA-C03 exam guide','https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03.html')],
    [awsDoc('AWS overview','https://docs.aws.amazon.com/whitepapers/latest/aws-overview/introduction.html'),awsDoc('AWS Regions and Availability Zones','https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-regions.html')],
    [awsDoc('What is IAM?','https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html'),awsDoc('AWS CLI authentication','https://docs.aws.amazon.com/cli/latest/userguide/cli-authentication-user.html')],
    [awsDoc('What is Amazon EC2?','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html'),awsDoc('EC2 instance types','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html'),awsDoc('EC2 security groups','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-security-groups.html')],
    [awsDoc('What is Amazon EC2?','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html'),awsDoc('EC2 networking','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html'),awsDoc('EC2 placement groups','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html')],
    [awsDoc('What is Amazon EBS?','https://docs.aws.amazon.com/ebs/latest/userguide/what-is-ebs.html'),awsDoc('EC2 instance store','https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html'),awsDoc('What is Amazon EFS?','https://docs.aws.amazon.com/efs/latest/ug/whatisefs.html')],
    [awsDoc('Elastic Load Balancing','https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/what-is-load-balancing.html'),awsDoc('Amazon EC2 Auto Scaling','https://docs.aws.amazon.com/autoscaling/ec2/userguide/what-is-amazon-ec2-auto-scaling.html')],
    [awsDoc('Amazon RDS and Aurora','https://docs.aws.amazon.com/rds/'),awsDoc('Amazon Aurora clusters','https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Aurora.Overview.html'),awsDoc('Amazon ElastiCache','https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/WhatIs.html')],
    [awsDoc('Amazon Route 53','https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/Welcome.html'),awsDoc('Route 53 routing policies','https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy.html')],
    [awsDoc('AWS Well-Architected Framework','https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html'),awsDoc('Reliability pillar','https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/welcome.html')],
    [awsDoc('What is Amazon S3?','https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html'),awsDoc('S3 storage classes','https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-class-intro.html')],
    [awsDoc('S3 Lifecycle management','https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lifecycle-mgmt.html'),awsDoc('S3 performance guidelines','https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance-guidelines.html')],
    [awsDoc('S3 security best practices','https://docs.aws.amazon.com/AmazonS3/latest/userguide/security-best-practices.html'),awsDoc('S3 access control','https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-management.html')],
    [awsDoc('Amazon CloudFront','https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Introduction.html'),awsDoc('AWS Global Accelerator','https://docs.aws.amazon.com/global-accelerator/latest/dg/what-is-global-accelerator.html')],
    [awsDoc('Amazon EFS','https://docs.aws.amazon.com/efs/latest/ug/whatisefs.html'),awsDoc('AWS Storage Gateway','https://docs.aws.amazon.com/storagegateway/latest/vgw/WhatIsStorageGateway.html'),awsDoc('AWS DataSync','https://docs.aws.amazon.com/datasync/latest/userguide/what-is-datasync.html')],
    [awsDoc('Amazon SQS','https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/welcome.html'),awsDoc('Amazon SNS','https://docs.aws.amazon.com/sns/latest/dg/welcome.html'),awsDoc('Kinesis Data Streams','https://docs.aws.amazon.com/streams/latest/dev/introduction.html')],
    [awsDoc('Amazon ECS','https://docs.aws.amazon.com/AmazonECS/latest/developerguide/Welcome.html'),awsDoc('Amazon EKS','https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html'),awsDoc('Amazon ECR','https://docs.aws.amazon.com/AmazonECR/latest/userguide/what-is-ecr.html')],
    [awsDoc('AWS Lambda','https://docs.aws.amazon.com/lambda/latest/dg/welcome.html'),awsDoc('Amazon API Gateway','https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html')],
    [awsDoc('Serverless Applications Lens','https://docs.aws.amazon.com/wellarchitected/latest/serverless-applications-lens/welcome.html'),awsDoc('AWS Lambda','https://docs.aws.amazon.com/lambda/latest/dg/welcome.html'),awsDoc('Amazon API Gateway','https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html')],
    [awsDoc('Amazon DynamoDB','https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Introduction.html'),awsDoc('Amazon RDS and Aurora','https://docs.aws.amazon.com/rds/'),awsDoc('Amazon ElastiCache','https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/WhatIs.html')],
    [awsDoc('Amazon Athena','https://docs.aws.amazon.com/athena/latest/ug/what-is.html'),awsDoc('AWS Glue','https://docs.aws.amazon.com/glue/latest/dg/what-is-glue.html'),awsDoc('Amazon Redshift','https://docs.aws.amazon.com/redshift/latest/mgmt/welcome.html')],
    [awsDoc('Amazon SageMaker AI','https://docs.aws.amazon.com/sagemaker/latest/dg/whatis.html'),awsDoc('Amazon Rekognition','https://docs.aws.amazon.com/rekognition/latest/dg/what-is.html'),awsDoc('Amazon Comprehend','https://docs.aws.amazon.com/comprehend/latest/dg/what-is.html')],
    [awsDoc('Amazon CloudWatch','https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html'),awsDoc('AWS CloudTrail','https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html'),awsDoc('AWS Config','https://docs.aws.amazon.com/config/latest/developerguide/WhatIsConfig.html')],
    [awsDoc('IAM policy evaluation logic','https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html'),awsDoc('AWS Organizations','https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html'),awsDoc('IAM Access Analyzer','https://docs.aws.amazon.com/IAM/latest/UserGuide/what-is-access-analyzer.html')],
    [awsDoc('AWS KMS','https://docs.aws.amazon.com/kms/latest/developerguide/overview.html'),awsDoc('AWS Secrets Manager','https://docs.aws.amazon.com/secretsmanager/latest/userguide/intro.html'),awsDoc('AWS WAF and Shield','https://docs.aws.amazon.com/waf/latest/developerguide/what-is-aws-waf.html')],
    [awsDoc('Amazon VPC','https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html'),awsDoc('VPC routing','https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html'),awsDoc('VPC security','https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Security.html')],
    [awsDoc('AWS Elastic Disaster Recovery','https://docs.aws.amazon.com/drs/latest/userguide/what-is-drs.html'),awsDoc('AWS Database Migration Service','https://docs.aws.amazon.com/dms/latest/userguide/Welcome.html'),awsDoc('AWS Transform MGN','https://docs.aws.amazon.com/mgn/latest/ug/what-is-mgn.html'),awsDoc('AWS Backup','https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html')],
    [awsDoc('Serverless Applications Lens','https://docs.aws.amazon.com/wellarchitected/latest/serverless-applications-lens/welcome.html'),awsDoc('High Performance Computing Lens','https://docs.aws.amazon.com/wellarchitected/latest/high-performance-computing-lens/welcome.html'),awsDoc('Amazon EC2 Auto Scaling','https://docs.aws.amazon.com/autoscaling/ec2/userguide/what-is-amazon-ec2-auto-scaling.html')],
    [awsDoc('AWS CloudFormation','https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html'),awsDoc('AWS Systems Manager','https://docs.aws.amazon.com/systems-manager/latest/userguide/what-is-systems-manager.html'),awsDoc('AWS Batch','https://docs.aws.amazon.com/batch/latest/userguide/what-is-batch.html'),awsDoc('AWS Amplify Hosting','https://docs.aws.amazon.com/amplify/latest/userguide/welcome.html')],
    [awsDoc('AWS Well-Architected Framework','https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html'),awsDoc('AWS Trusted Advisor','https://docs.aws.amazon.com/awssupport/latest/user/trusted-advisor.html')],
    [awsDoc('SAA-C03 exam guide','https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03.html'),awsDoc('AWS Well-Architected Framework','https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html')],
    [awsDoc('AWS Certification exam guides','https://docs.aws.amazon.com/aws-certification/latest/examguides/aws-certification-exam-guides.html'),awsDoc('SAA-C03 exam guide','https://docs.aws.amazon.com/aws-certification/latest/solutions-architect-associate-03.html')]
  ];
  ...
  sectionAwsDocs.forEach((docs,index)=>{window.AWS_COURSE_CURRICULUM[index].awsDocs=docs});
})();
